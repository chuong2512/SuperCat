...
namespace EnhancedUI.EnhancedScroller
{
    ...
    public delegate void CellViewVisibilityChangedDelegate(ICellView cellView);

    /// <summary>
    /// This delegate will be fired just before the cell view is recycled
    /// </summary>
    /// <param name="cellView"></param>
    public delegate void CellViewWillRecycleDelegate(ICellView cellView);
    ...
    public delegate void ScrollerSnappedDelegate(EnhancedScroller scroller, int cellIndex, int dataIndex, ICellView cellView);
    ...
    public delegate void CellViewInstantiated(EnhancedScroller scroller, ICellView cellView);
    ...
    public delegate void CellViewReused(EnhancedScroller scroller, ICellView cellView);
    ...
    public class EnhancedScroller : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler
    {
        ...
        /// <returns></returns>
        public virtual ICellView GetCellView(ICellView cellPrefab)
        {
            ...
            if (cellView == null)
            {
                ...
                cellView = Instantiate(cellPrefab.Transform).GetComponent<ICellView>();
            ...
            else
            {
                ...
                cellView.Transform.gameObject.SetActive(true);
        ...
        public void ClearActive()
        {
            for (var i = 0; i < _activeCellViews.Count; i++)
            {
                DestroyImmediate(_activeCellViews[i].Transform.gameObject);
            }
        ...
        public void ClearRecycled()
        {
            ...
            {
                DestroyImmediate(_recycledCellViews[i].Transform.gameObject);
            }
        ...
        public int GetCurrentCellViewIndexAtPosition()
        {
            ...
            if (scrollDirection == ScrollDirectionEnum.Horizontal)
            {
                ...
                {
                    return _GetCellIndexAtPosition(
                        _scrollPosition + ScrollRectSize , 0,
                        _cellViewOffsetArray.Count - 1);
                }

                return _GetCellIndexAtPosition(
                    _scrollPosition, 0, _cellViewOffsetArray.Count - 1);
            }
            ...
            {
                return _GetCellIndexAtPosition(
                    _scrollPosition + (ScrollRectSize * Mathf.Clamp01(snapWatchOffset)), 0,
                    _cellViewOffsetArray.Count - 1);
            }
            
            return _GetCellIndexAtPosition(_scrollPosition + (ScrollRectSize * Mathf.Clamp01(snapWatchOffset)), 0, _cellViewOffsetArray.Count - 1);
        }
        ...
        /// <returns></returns>
        public ICellView GetCellViewAtDataIndex(int dataIndex)
        {
            for (var i = 0; i < _activeCellViews.Count; i++)
            {
        ...
        /// </summary>
        private SmallList<ICellView> _recycledCellViews = new ();
        ...
        /// </summary>
        private SmallList<ICellView> _activeCellViews = new ();
        ...
        /// <returns></returns>
        private ICellView _GetRecycledCellView(ICellView cellPrefab)
        {
            for (var i = 0; i < _recycledCellViews.Count; i++)
            {
        ...
        /// </summary>
        /// <param name="cellView"></param>
        private void _RecycleCell(ICellView cellView)
        {
        ...
        private void _AddCellView(int cellIndex, ListPositionEnum listPosition)
        {
            ...
            LayoutElement layoutElement = cellView.Transform.GetComponent<LayoutElement>();
            if (layoutElement == null) layoutElement = cellView.Transform.gameObject.AddComponent<LayoutElement>();
